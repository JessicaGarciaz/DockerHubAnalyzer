...
class ImageAnalyzer {
    constructor(config = null) {
        this.config = config;
        this.registryBase = config ? config.get('registry.baseUrl', 'https://registry-1.docker.io/v2') : 'https://registry-1.docker.io/v2';
        this.authBase = config ? config.get('registry.authUrl', 'https://auth.docker.io/token') : 'https://auth.docker.io/token';
    }
